...
function addData(){
   ...
   if(validateForm() == true){
    ...
    localStorage.setItem("calificacionesList", JSON.stringify(calificacionesList));
    showData();
...
function updateData(index){
    ...
    document.querySelector("#Update").onclick = function(){
        if(validateForm() == true){
            calificacionesList[index].nombre = document.getElementById("nombre").value;
            calificacionesList[index].materia = document.getElementById("materia").value;
